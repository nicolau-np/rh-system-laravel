                        ...
                        <div class="col-md-5">
                            <form class="formSeach" action="#">
                                <div class="form-inline">
                                    ...
                                    <a href="/bancos/new" class="btn btn-success btn-sm" title="Novo"><i class="fa fa-plus"></i></a>&nbsp;
                                    </div>
                            </form>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover mb-none">
                                    ...
                                    <tbody>
                                        @foreach($getBancos as $bancos)
                                        <tr>
                                            <td>{{$bancos->id}}</td>
                                            <td>{{$bancos->banco}}</td>
                                            <td>{{$bancos->sigla}}</td>
                                            <td class="actions-hover actions-fade">
                                                <a href="/bancos/show/{{$bancos->id}}" title="Visualizar"><i class="fa fa-eye fa-2x"></i></a>&nbsp;
                                                <a href="/bancos/edit/{{$bancos->id}}" title="Editar"><i class="fa fa-pencil fa-2x"></i></a>&nbsp;

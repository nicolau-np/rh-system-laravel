...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            {{Form::open(['class'=>'formFuncionario', 'url'=>"/funcionarios/update/{$getFuncionario->id}/{$getFuncionario->pessoa->id}", 'enctype'=>"multipart/form-data", 'method'=>'put'])}}
            <section class="panel">
                    ...
                    <fieldset class="dados_pessoais">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::date('data_nascimento', $getFuncionario->pessoa->data_nascimento, ['class'=>'form-control input-sm'])}}
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::select('estado_civil',
                                        ['solteiro(a)'=>'solteiro(a)',
                                          'casado(a)'=>'casado(a)'
                                        ],$getFuncionario->pessoa->estado_civil,
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-2">
                                ...
                                {{Form::select('provincia',
                                        $getProvincia,$getFuncionario->pessoa->municipio->provincia->id,
                            ...
                            <div class="col-lg-2 muncipio">
                                ...
                                {{Form::select('municipio',
                                        [$getFuncionario->pessoa->municipio->id => $getFuncionario->pessoa->municipio->municipio],$getFuncionario->pessoa->municipio->id,
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::text('bi', $getFuncionario->pessoa->bi, ['class'=>'form-control input-sm', 'placeholder'=>'Nº de Bilhete'])}}
                                @if($errors->has('bi'))
                            ...
                            <div class="col-lg-2">
                                ...
                                {{Form::date('data_emissao', $getFuncionario->pessoa->data_emissao, ['class'=>'form-control input-sm', 'placeholder'=>'Data de Emissão'])}}
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::text('local_emissao', $getFuncionario->pessoa->local_emissao, ['class'=>'form-control input-sm', 'placeholder'=>'Local de Emissão'])}}
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::number('telefone', $getFuncionario->pessoa->telefone, ['class'=>'form-control input-sm', 'placeholder'=>'Nº de Telefone'])}}
                            ...
                            <div class="col-lg-2">
                                ...
                                {{Form::text('comuna',$getFuncionario->pessoa->comuna, ['placeholder'=>'Comuna','class'=>'form-control input-sm'])}}
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::text('pai', $getFuncionario->pessoa->nome_pai, ['class'=>'form-control input-sm', 'placeholder'=>'Nome do Pai'])}}
                                @if($errors->has('pai'))
                        ...
                        <div class="row group">
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::text('mae', $getFuncionario->pessoa->nome_mae, ['class'=>'form-control input-sm', 'placeholder'=>'Nome da Mãe'])}}
                                @if($errors->has('mae'))
                    ...
                    <fieldset class="dados_profissionais">
                        ...
                        <div class="row group">
                            <div class="col-lg-3">
                                ...
                                {{Form::select('cargo',
                                        $getCargo,$getFuncionario->cargo->id,
                                        ['placeholder'=>'Cargo',
                                         'class'=>'form-control input-sm'
                                        ]
                                        )}}
                            ...
                            <div class="col-lg-2">
                                ...
                                {{Form::number('salario_base', $getFuncionario->salario_base, ['placeholder'=>'Salário Base', 'class'=>'form-control input-sm'])}}
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::date('data_ingresso', $getFuncionario->data_entrada, ['class'=>'form-control input-sm'])}}
                            ...
                            <div class="col-lg-3">
                                ...
                                {{Form::select('banco',
                                        $getBancos,$getFuncionario->conta_bancaria->banco->id,
                                        ['placeholder'=>'Banco',
                                         'class'=>'form-control input-sm'
                                        ]
                                        )}}
                        ...
                        <div class="row group">
                            <div class="col-lg-3">
                                ...
                                {{Form::text('conta', $getFuncionario->conta_bancaria->conta, ['placeholder'=>'Nº da Conta', 'class'=>'form-control input-sm'])}}
                            ...
                            <div class="col-lg-5">
                                ...
                                {{Form::text('iban', $getFuncionario->conta_bancaria->iban, ['placeholder'=>'Nº de IBAN', 'class'=>'form-control input-sm'])}}
                            ...
                            <input type="hidden" name="foto_antiga" value="{{$getFuncionario->pessoa->foto}}"/>
                        </div>
                    </fieldset>

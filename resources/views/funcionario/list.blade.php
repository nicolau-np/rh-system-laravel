                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions-hover actions-fade">
                                                <a href="/funcionarios/show/{{$funcionarios->id}}" title="Visualizar"><i class="fa fa-eye fa-2x"></i></a>&nbsp;
                                                <a href="/funcionarios/edit/{{$funcionarios->id}}" title="Editar"><i class="fa fa-pencil fa-2x"></i></a>&nbsp;
                                                <a href="/funcionarios/docs/{{$funcionarios->id}}" title="Documentos"><i class="fa fa-briefcase fa-2x"></i></a>&nbsp;
                                                <a href="/usuarios/new/{{$funcionarios->pessoa->id}}" title="Usuário"><i class="fa fa-lock fa-2x"></i></a>&nbsp;
